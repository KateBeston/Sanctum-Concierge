...
//   4. Applies the "Sanctum Journal" tag (this is what your AC automation should trigger on).
//   5. If the visitor also ticked the second, optional checkbox, applies the
...
//   TAG_NAME and GENERAL_TAG_NAME must exactly match the tag names in ActiveCampaign
//   (or they'll simply be created fresh the first time someone signs up).
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // 4) Apply the "Sanctum Journal" tag — this is what your AC automation should trigger on
    ...
    // 5) If they also ticked the second, optional checkbox, apply the SEPARATE
